...
type ExamDraft = { title: string; level: string; year: string; month: string; sourceName: string; sourceUrl: string; status: "draft" | "published" };
...
export function ExamRegistrationForm() {
  ...
  const [exam, setExam] = useState<ExamDraft>({ title: "", level: "", year: "2026", month: "", sourceName: "", sourceUrl: "", status: "published" });
